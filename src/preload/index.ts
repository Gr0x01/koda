...
const api: KodaApi = {
  ...
  queueTurn: (args) => ipcRenderer.invoke(IpcChannels.queueTurn, args),
  cancelQueuedTurn: (args) => ipcRenderer.invoke(IpcChannels.cancelQueuedTurn, args),
  listQueuedTurns: () => ipcRenderer.invoke(IpcChannels.queuedTurnsList),
