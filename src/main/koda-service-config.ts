 ...
 *
 * The public client ships with NO Koda service identifiers. Cloud relay, phone control, and the
 * hosted feedback sink stay inert until you point them at your own infrastructure via env:
 *   KODA_SUPABASE_URL, KODA_SUPABASE_KEY, KODA_RELAY_URL, KODA_FEEDBACK_HANDSHAKE
